...
author = "观山"
categories = ["技术", "视频"]
date = "2016-06-21T22:03:16+08:00"
description = "description"
draft = false
tags = ["ffmpeg", "srs", "RTMP"]
title = "rtmp服务器搭建以及推流程序demo"

+++

汇总下前段时间用的工具：使用开源程序SRS和ffmpeg搭建推流程序的demo。

## 准备工作
* Linux服务器一台
* git（apt-get or yum install git）
* [srs开源程序](https://github.com/smartdu/srs)
* [ffmpeg](http://ffmpeg.org/download.html)
<!--more-->

## 安装srs

1. git https://github.com/smartdu/srs.git
2. cd srs/trunk
3. ./configure && make
4. ./objs/srs -c conf/srs.conf
5. 其他详见项目[wiki](https://github.com/ossrs/srs/wiki)

## 安装ffmpeg

1. git clone https://git.ffmpeg.org/ffmpeg.git ffmpeg
2. 安装yasm(apt-get or yum install yasm)
3. ./configure --enable-shared --prefix=/usr/local/ffmpeg
4. make && make install
5. vim /etc/ld.so.conf.d/libc.conf,添加/usr/local/ffmpeg/lib
   路径根据不同系统可能有差异
6. ldconfig,使上面的改动生效
...
```
INCPATH=-I /usr/local/ffmpeg/include
